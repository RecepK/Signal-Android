...
public class SignalServiceNetworkAccess {
  ...
  public SignalServiceNetworkAccess(Context context) {
    ...
    final SignalServiceUrl amazonService    = new SignalServiceUrl("https://m.media-amazon.com", SERVICE_REFLECTOR_HOST, trustStore, MEDIA_AMAZON_CONNECTION_SPEC);
    ...
    final SignalCdnUrl     amazonServiceCdn = new SignalCdnUrl("https://m.media-amazon.com", SERVICE_REFLECTOR_HOST, trustStore, MEDIA_AMAZON_CONNECTION_SPEC);
    ...
    final SignalServiceConfiguration omanQatarConfig = new SignalServiceConfiguration(new SignalServiceUrl[]{ amazonService },
                                                                                      new SignalCdnUrl[] { amazonServiceCdn });
